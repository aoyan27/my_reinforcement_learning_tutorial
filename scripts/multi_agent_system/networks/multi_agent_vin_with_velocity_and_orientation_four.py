...
class ValueIterationNetwork(Chain):
    ...
    def __call__(self, input_data, my_state_list, my_velocity_list, my_orientation_list, \
                 ...
                 other_state_list3, other_velocity_list3, other_orientation_list3):
        ...
        other_state3_ = other_state_list3.astype(np.float32)
        #  print "other_state3_ : ", other_state3_
        other_velocity3_ = other_velocity_list3.astype(np.float32)
        #  print "other_velocity3_ : ", other_velocity3_
        other_orientation_size3 = other_orientation_list3.shape[0]
        other_orientation3_ \
                = other_orientation_list3.astype(np.float32).reshape(other_orientation_size3, 1)
        #  print "other_orientation3_ : ", other_orientation3_
        ...
        other_state3 = F.concat((other_state3_, other_velocity3_), axis=1)
        other_state3 = F.concat((other_state3, other_orientation3_), axis=1)
        #  print "other_state3 : ", other_state3
        ...
        concat_3 = F.concat((concat_2, other_state3), axis=1)
        #  print "concat_3 : ", concat_3

        #  h1 = self.l4(concat_1)
        #  h2 = self.l5(h1)
        #  y = self.l6(h2)

        h1 = F.relu(self.l4(concat_3))
