...
from networks.multi_agent_vin_symmetrical_net2_2agents import ValueIterationNetwork
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dataset', \
            default='datasets/multi_agent_object_world_velocity_orientation_future_2_agents_map_dataset.pkl', \
