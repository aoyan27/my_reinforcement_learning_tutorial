...
def cvt_input_data(grid_image, another_agent_position_grid, reward_map):
    input_data = \
            np.concatenate((np.expand_dims(grid_image, 0), \
            np.expand_dims(another_agent_position_grid, 0)), axis=0)

    input_data = \
            np.concatenate((input_data, np.expand_dims(reward_map, 0)), axis=0)
...
def get_my_agent_action(env, model, grid_map, reward_map, \
    ...
    #  print "reward_imag : "
    #  print reward_map
    another_agent_position_grid = np.zeros(grid_map.shape)
    another_agent_position_grid[tuple(another_agent_position)] = 1
    #  print "another_agent_position_grid : "
    #  print another_agent_position_grid
    input_data = cvt_input_data(grid2image(grid_map), another_agent_position_grid, reward_map)
    #  print "input_data : "
    #  print input_data
