...
def view_three_image(fig, array1, array2, array3, array4, \
    ...
    image4 = cv.cvtColor(array4.astype(np.uint8), cv.COLOR_GRAY2RGB)
    print "image4 : ", image4[int(state4[0]), int(state4[1])]
    image4[int(state4[0]), int(state4[1]), :] = [1, 0, 0]
    ...
    ax4.text(image4.shape[0]/4.0, image4.shape[1]+3, action_text4)
    ...
    velocity_text4 = 'velocity : [%.3f, %.3f]' % (velocity4[0], velocity4[1])
    ...
    ax4.text(image4.shape[0]/4.0, image4.shape[1]+4, velocity_text4)
    ...
    orientation_text4 = 'orientation: %.3f' % (orientation4)
    ...
    ax4.text(image4.shape[0]/4.0, image4.shape[1]+5, orientation_text4)
