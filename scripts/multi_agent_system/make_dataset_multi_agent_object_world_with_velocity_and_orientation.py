...
def get_input_image(env, state_list, action_list, n_agents, n_trajs):
    domain_grid_list = {}
            ...
            for agent_id in xrange(n_agents):
                ...
                for another_agent_id in xrange(n_agents):
                    ...
                    if another_agent_id != agent_id:
                        ...
                        another_agent_position = state_list[another_agent_id][i_traj][i_step]
...
def check_agent_collision(n_agents, state_list):
    ...
    for flag in tmp_flag:
        agent_collision_flag.append(np.allclose(flag, ok_flag))
...
def get_trajs(env, n_agents, n_trajs):
    ...
    while j < n_trajs:
        ...
        for agent_id in xrange(n_agents):
            ...
            domain_state_list[agent_id], domain_action_list[agent_id], found[agent_id] \
        ...
        if all(found):
            ...
            if check_agent_collision(n_agents, domain_state_list):
                for agent_id in xrange(n_agents):
...
def main(rows, cols, n_objects, n_agents, n_domains, n_trajs, seed, save_dirs):
    ...
    while dom < n_domains:
        ...
        grid_image_list, agent_grid_image_list, another_agent_position_with_grid_image_list\
                = get_input_image(env, state_list, action_list, n_agents, n_trajs)
    ...
    dataset_name ='multi_agent_object_world_velocity_orientation_map_dataset.pkl'
