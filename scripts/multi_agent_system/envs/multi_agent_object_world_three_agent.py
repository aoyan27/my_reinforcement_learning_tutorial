...
class Objectworld:
    def __init__(self, rows, cols, n_objects, num_agent, noise,\
            start={0: [0, 0], 1: [4, 4], 2: [4, 0]}, goal={0: [4, 4], 1: [0, 0], 2: [0, 4]}, \
    ...
    def reset(self, start_position={0: [0, 0], 1: [4, 4], 2: [4, 0]}, \
                    goal_position={0: [4, 4], 1: [0, 0], 2: [0, 4]}, random=False):
...
if __name__=="__main__":
    ...
    start = {0: [2, 2], 1: [18, 18], 2:[17, 2]}
    goal = {0: [19, 19], 1:[0, 0], 2:[0, 19]}
