...
from agents.immediate_reward import ImmediateRewardAgent
...
def main(rows, cols, act_noise, n_objects, seed, l_rows, l_cols, model_name):
    ...
    for i in xrange(max_episode):
        ...
        for j in xrange(max_step):
            ...
            vis_local_map = copy.deepcopy(observation[1])
            vis_local_map[env.local_goal] = 1.0
            plt.subplot(1, 2, 1)
            heatmap_2d(vis_local_map, 'Local Grid')
            ...
            action = agent.get_action(reward)
