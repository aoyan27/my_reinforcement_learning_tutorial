...
from networks.vin_continuous_velocity_vector_fine_tuning_2 import ContinuousValueIterationNetwork
...
def main(dataset, n_epoch, batchsize, gpu, model_path, load_model_path):
    ...
    model = ContinuousValueIterationNetwork(l_q=9, n_out=11, k=25, net=load_model_)
    ...
    optimizer.add_hook(DelGradient(["conv1","conv2","conv3a","conv3b", "l4"]))
