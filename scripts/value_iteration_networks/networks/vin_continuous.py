...
class ValueIterationNetwork(Chain):
    ...
    def __call__(self, input_data, position_list, orientation_list):
        ...
        h_in = F.concat((q_out, input_policy), axis=1)
        #  print "h_in : ", h_in
    ...
    def forward(self, input_data, position_list, orientation_list, action_list):
        y = self.__call__(input_data, position_list, orientation_list)
        #  print "y : ", y
