...
class ValueIterationNetwork(Chain):
    ...
    def __call__(self, input_data, goal_list, \
                 position_list, orientation_list, velocity_vector_list):
    ...
    def forward(self, input_data, goal_list, position_list, orientation_list, \
                action_list, velocity_vector_list):
        y = self.__call__(input_data, goal_list, \
                          position_list, orientation_list, velocity_vector_list)
        #  print "y : ", y
