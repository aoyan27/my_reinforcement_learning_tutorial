...
def load_dataset(path):
    ...
    return image_data, reward_map_data, position_list_data, orientation_list_data, action_list_data
...
def train_and_test(model, optimizer, gpu, model_path, train_data, test_data, n_epoch, batchsize):
    ...
    while epoch <= n_epoch:
        ...
        for i in xrange(0, n_train, batchsize):
            ...
            model.zerograds()
            loss, acc = model.forward(batch_input_data, batch_position_list, \
