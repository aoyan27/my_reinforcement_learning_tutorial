...
def get_trajs(env, n_trajs):
    ...
    while j < n_trajs:
        ...
        agent.get_shortest_path(env.state_, env.orientation_)
        
        if agent.found:
            #  print "agent.state_list : "
            #  print "agent.orientation_list : "
            #  print agent.state_list
            ...
            domain_orientation_list.append(agent.orientation_list)
            domain_action_list.append(agent.shortest_action_list)

        #  print "domain_state_list : "
        #  print domain_state_list
        #  print "domain_orientation_list : "
        #  print domain_orientation_list
    ...
    if failed:
        ...
        del domain_orientation_list[:]
        del domain_action_list[:]

    return domain_state_list, domain_orientation_list, domain_action_list
...
def main(rows, cols, n_objects, n_domains, n_trajs, seed, save_dirs):
    ...
    #  print "orientation_list_data : ", orientation_list_data.shape
    ...
    while dom < n_domains:
        ...
        state_list, orientation_list, action_list = get_trajs(env, n_trajs)
        if len(state_list) == 0:
            continue
        #  print "state_list : ", state_list[0]
        #  print "orientation_list : ", orientation_list[0]
    ...
    dataset_name ='map_dataset_with_orientation.pkl'
